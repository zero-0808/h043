...
static void HAL_FMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOG, GPIO_PIN_15|GPIO_PIN_9|GPIO_PIN_8|GPIO_PIN_5
                          |GPIO_PIN_4|GPIO_PIN_2|GPIO_PIN_1|GPIO_PIN_0);

  HAL_GPIO_DeInit(GPIOD, GPIO_PIN_0|GPIO_PIN_5|GPIO_PIN_1|GPIO_PIN_4
                          |GPIO_PIN_15|GPIO_PIN_14|GPIO_PIN_12|GPIO_PIN_11
  ...
  HAL_GPIO_DeInit(GPIOH, GPIO_PIN_5|GPIO_PIN_7);
